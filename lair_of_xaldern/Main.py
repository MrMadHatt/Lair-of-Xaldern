...
def main():
    ...
    game_status = "playing"
    action_message = (
        "...Awaken, Hero......the world needs your strength once more.........."
    )
    ...
    while game_status == "playing":
        ...
        if user_input == "quit":
            ...
            picked_up = item_management.pick_up_item(
                conn, user_input, current_room_id, inventory
            )
            if picked_up:
            ...
            dropped = item_management.drop_item(
                conn, user_input, current_room_id, inventory
            )
            if dropped:
